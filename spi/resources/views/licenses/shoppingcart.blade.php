    ...
    <form method="POST" action="{{ url('/licenses/shoppingcart') }}" accept-charset="UTF-8" class="form-horizontal" mothod="POST">
        ...
        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 rounded-form-container">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6  rounded-form">
                ...
                <div class="form-group">
                    <label for="total" class="col-md-3 col-sm-3 col-xs-3 control-label vcenter pad0 text-right">Total Price</label><div class="col-md-9 col-sm-9 col-xs-9 vcenter" style="padding-top: 20px;" id="totle">$ 15.00 (Total amount that will be added to your existing monthly billing amount.)</div>
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6  rounded-form">
                ...
                <div class="form-group marg-top-30">
                    <label for="first_name" class="col-md-3 col-sm-3 col-xs-3 control-label vcenter pad0 text-right">First Name*</label><div class="col-md-9 col-sm-9 col-xs-9 vcenter"><input class="form-control" required="required" name="first_name" type="text" value="{{ Auth::user()->first_name}}"></div>
                </div>
                <div class="form-group">
                    <label for="last_name" class="col-md-3 col-sm-3 col-xs-3 control-label vcenter pad0 text-right">Last Name*</label><div class="col-md-9 col-sm-9 col-xs-9 vcenter"><input class="form-control" required="required" name="last_name" type="text" value="{{ Auth::user()->last_name}}"></div>
                </div>
                <div class="form-group">
                    <label for="company" class="col-md-3 col-sm-3 col-xs-3 control-label vcenter pad0 text-right">Company*</label><div class="col-md-9 col-sm-9 col-xs-9 vcenter"><input class="form-control" required="required" name="company" type="text" value="{{ Auth::user()->company->name}}"></div>
                </div>
                <div class="form-group">
                    <label for="addressLine1" class="col-md-3 col-sm-3 col-xs-3 control-label vcenter pad0 text-right">Address Line1*</label><div class="col-md-9 col-sm-9 col-xs-9 vcenter"><input class="form-control" required="required" name="addressLine1" type="text" value="{{ Auth::user()->address1}}"></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="country" class="col-md-3 col-sm-3 col-xs-3 control-label vcenter pad0 text-right">Country*</label><div class="col-md-9 col-sm-9 col-xs-9 vcenter">
                        <select class="form-control" id="role_id" name="country" onchange="setAction('2')">
                            ...
                            <option value="United States" style="font-weight: bold;">United States</option>
                            <option value="Canada" style="font-weight: bold;">Canada</option>
                ...
                <div class="form-group">
                    <label for="phoneNumber" class="col-md-3 col-sm-3 col-xs-3 control-label vcenter pad0 text-right">Phone Number*</label><div class="col-md-9 col-sm-9 col-xs-9 vcenter"><input class="form-control" required="required" name="phoneNumber" type="text" value="{{ Auth::user()->contact_number}}"></div>
                </div>
                <div class="form-group">
                    <label for="emailAddress" class="col-md-3 col-sm-3 col-xs-3 control-label vcenter pad0 text-right">Email Address*</label><div class="col-md-9 col-sm-9 col-xs-9 vcenter"><input class="form-control" required="required" name="emailAddress" type="text" value="{{ Auth::user()->email}}"></div>
                </div>
              </div> 
        </div>
        <div class="hidden-xs hidden-sm col-md-1 col-lg-1"></div>
...
<script>
    function cal(val) {
        var ammount = val * 15;
        document.getElementById('totle').innerHTML = '$ ' + ammount + '.00 (Total amount that will be added to your existing monthly billing amount.)';
    }
</script>
@endsection
