    ...
    <div class="page-header" id="banner">
        <div class="row">
            <div class="col-lg-8 col-md-7 col-sm-6">
                <h2>You have scored {{ empty( $today_total->total ) ? '0' : number_format($today_total->total) }} points so far today ( {{ empty($today_total->total) ? '0' : $today_total->date }} ). Your minimum daily goal is {{ $today_target }}.</h2>
            </div>
        </div>
    </div>
    <div class="row">
